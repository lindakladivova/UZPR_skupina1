...
\subsection{MBTiles}
Jde o formát, který slouží pro ukládání mnoho mapových dlaždic v jednom souboru. V podstatě se jedná o jednoduchou souborovou sqlite databázi s pár tabulkami. Může obsahovat rastrová nebo vektorová data.
